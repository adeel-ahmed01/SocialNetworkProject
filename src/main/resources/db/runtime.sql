INSERT INTO public.user(id, email, nom, prenom, password, access) VALUES(0, 'adeel@cgi.com', 'AHMED', 'Adeel', '123', 'ADMIN');
INSERT INTO public.user(id, email, nom, prenom, password, access) VALUES(1, 'steven@cgi.com', 'GUILLOMET', 'Steven', '456', 'USER');
INSERT INTO public.user(id, email, nom, prenom, password, access) VALUES(2, 'valentin@cgi.com', 'DEVERNOIS', 'Valentin', '789', 'USER');
